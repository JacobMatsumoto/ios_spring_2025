...
class Unit {
    ...
    init(name: String, atk: Float, leaderSkill: Float, passive: Float, links: Float, item: Float, ki: Float, passive2: Float, superatk: Float) {
        self.name = name
        self.atk = atk
...
class Boss{
    ...
    init(bossName: String, bossDef: Float, bossDmgReduction: Float, bossHp: Float, bossDmg: Float, bossDmgSuper: Float) {
...
var kidBuu = Boss(bossName: "Kid Buu", bossDef: 650000, bossDmgReduction: 0.25, bossHp: 90000000, bossDmg: 1, bossDmgSuper: 1) //setting up "kidbuu" as a boss
...
func dmgVsBoss(_ Unit: Unit, _ Boss: Boss) {
    ...
    var dmgDealtNormal = dmgDealt * Boss.bossDmgReduction
    var dmgDealtSE = dmgDealtNormal * 1.5
    var dmgDealtCrit = Unit.calcAtkStat() * Boss.bossDmgReduction * 1.9 //1.9 is the crit multiplier, make it a global
